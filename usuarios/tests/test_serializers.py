...
class TestRegistraUsuarioSerializer(TestCase):
    ...
    def test_registra_usuario_serializer_is_valid_false_senhas_diferentes(self):
        request = {
            "username": "flavio",
            "password1": "teste123!",
            "password2": "teste123",
    ...
    def test_registra_usuario_serializer_is_valid_false_senha_fraca_somente_caracteres(
        ...
        request = {"username": "flavio", "password1": "teste", "password2": "teste"}
    ...
    def test_registra_usuario_serializer_is_valid_false_username_existente(self):
